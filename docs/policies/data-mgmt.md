...
CloudCore and CloudCore Customers, complete backups are done daily to assure that
...
Customers can also utilize the CloudCore Application Programming Interface (API)
