...
CloudCore hosts on Amazon Web Services in the US-East (Ohio) region by default.
...
built into Amazon Machine Images (AMIs) for use in CloudCore AWS
environments.
...
5. For all CloudCore APIs, enforcement of authentication, authorization, and
